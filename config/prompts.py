...
"""
提示词配置文件
所有 LLM 提示词统一管理，便于维护和调整

提示词与模型对应关系：
┌─────────────────────────────┬───────────────┬────────────────────────┐
│ Prompt 名称                  │ 使用模型       │ 功能                    │
├─────────────────────────────┼───────────────┼────────────────────────┤
│ SYSTEM_AGENT_PROMPT         │ qwen-max      │ Agent 调度决策          │
│ VISION_EXTRACT_PROMPT       │ qwen-vl-plus  │ 图片识别提取题目         │
│ DIAGRAM_TYPES_PROMPT        │ (参数)        │ 图形类型说明            │
│ DIAGRAM_ANALYSIS_PROMPT     │ qwen-max      │ 分析题目需要的图形类型   │
│ VARIANT_QUESTIONS_PROMPT    │ DeepSeek      │ 生成变式题              │
└─────────────────────────────┴───────────────┴────────────────────────┘
"""
...
# =============================================================================
# qwen-max：Agent 调度决策
# 功能：定义 Agent 的行为规则，决定何时调用什么工具
# 位置：core/agent.py → LinPaperAgent.__init__()
# =============================================================================
...
# qwen-vl-plus：图片识别
# 功能：识别图片中的数学公式或题目内容
# 位置：tools/vision_tool.py → vision_extract_latex()
# =============================================================================
VISION_EXTRACT_PROMPT = """请识别这张图片中的数学公式或题目内容。
...
# =============================================================================
# 图形类型说明（作为参数传给 DIAGRAM_ANALYSIS_PROMPT）
# 功能：列出所有支持的图形类型和参数格式
# =============================================================================
...
# =============================================================================
# qwen-max：图形分析
# 功能：分析题目需要绘制什么类型的图形，返回图形参数
# 位置：tools/pdf_tool.py → get_diagram_params_from_qwen()
# =============================================================================
...
# DeepSeek：变式题生成
# 功能：根据原始题目生成变式练习题
# 位置：tools/pdf_tool.py → generate_pdf_paper()
# =============================================================================
